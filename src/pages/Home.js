    ...
    <>
      ...
      >
        ...
        <p
          ...
          style={{ fontSize: "14px" }}
        >
          If you need any help with your plumbing, give us a call at Cape
          Estates Plumbing. We offer variety of plumbing services.
        </p>
      ...
      <div className="py-5 bg-white shadow rounded-md my-5 md:mx-5 px-3 md:px-0">
        <div className="text-center flex flex-col space-y-2 my-6">
          ...
          <p className="font-bold text-3xl md:text-4xl text-blue-500">
            What clients say
          </p>
