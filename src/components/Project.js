...
const Projects = () => {
  ...
  return (
    <div className="bg-white md:mx-5 rounded-md py-8">
      <h2 className="text-blue-500 font-bold text-4xl text-center pt-5 pb-2">
        Recent works
      </h2>
      <p
        ...
        style={{ fontSize: "14px" }}
      >
        Action speaks louder than words, check our successful completed projects
        to clear all the doubts. We are professional in this work
      </p>
